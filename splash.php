  ...
  <body>
    <div class="main_grid">
        ...
        <section>
          ...
          <div class="cham1">
            <p id="linha1">Obrigado, seu registro foi incluido. Você já garantiu 15% de desconto, além de participar de promoções você terá acesso antecipado aos nossos lançamentos</p>
          </div>
